...
Make sure every opening brace and bracket has a matching closing brace or bracket.
Do not stop before the JSON object is complete.`;
    ...
    if (!cleaned) {
      throw new HFParseError(
        "Gemini returned an empty structured response after retry."
      );
    }
