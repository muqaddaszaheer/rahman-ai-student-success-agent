...
Never invent student progress, scores, completed work, strengths, weaknesses, or knowledge.
...
async function generateStudyPlan(state) {
  ...
  const note = feasibility.feasible
    ...
    : `The roadmap needs more time than the requested ${durationDays} days. At ${dailyMinutes} minutes per day, plan for at least ${feasibility.minDaysNeeded} days.`;
...
Give practical, focused, and encouraging guidance.

Rules:
- Answer the student's message directly.
...
- Give 2 to 4 clear next steps when useful.
- Keep the answer concise.
- Do not repeat the student's information unnecessarily.
- Do not use tables.
- Do not return JSON.
...
Be supportive, accurate, practical, beginner-friendly, and concise.
